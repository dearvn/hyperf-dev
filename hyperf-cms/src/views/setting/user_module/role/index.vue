...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 1, field: 'name', label: `Role Name`, visible: true },
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.roleDetailDialogData.roleDetailTitle = 'Add a role'
    ...
    handleEdit(index, row) {
      this.roleDetailDialogData.roleDetailDialogVisible = true
      this.roleDetailDialogData.roleDetailTitle = 'Revise "' + row.desc + '" user'
