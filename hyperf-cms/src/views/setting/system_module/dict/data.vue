  ...
  <div class="app-container">
    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="Dictionary" align="center" prop="dict_code" v-if="columns[0].visible"></el-table-column>
        <el-table-column label="Dictionary label" prop="dict_label" align="center" v-if="columns[1].visible"></el-table-column>
        <el-table-column label="Dictionary key value" align="center" prop="dict_value" v-if="columns[2].visible"></el-table-column>
        <el-table-column
          label="Dictionary"
          width="140"
          align="center"
...
export default {
  ...
  data() {
    return {
      ...
      total: 0,
      columns: [
        { key: 0, field: 'dict_code', label: `Dictionary`, visible: true },
        { key: 1, field: 'dict_label', label: `Dictionary label`, visible: true },
        { key: 2, field: 'dict_value', label: `Dictionary key value`, visible: true },
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.dictDataDetailDialogData.dictDataDetailTitle = 'Add dictionary data'
