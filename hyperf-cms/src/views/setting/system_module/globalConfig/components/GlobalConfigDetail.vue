<template>
  ...
  >
    <el-form :model="globalConfig" :rules="rules" ref="globalConfigForm" label-width="90px">
      ...
      <el-form-item label="KeyName" prop="key_name">
        <el-input
          ...
          auto-complete="off"
          size="medium"
          placeholder="Please fill in key_name"
        ></el-input>
      </el-form-item>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button type="primary" @click="onSubmit('globalConfigForm')">Submit</el-button>
      <el-button
  ...
  data() {
    return {
      ...
      rules: {
        ...
        key_name: [
          { required: true, message: 'Please fill in key_name', trigger: 'blur' },
          {
            min: 2,
            max: 60,
            message: 'The length is from 2 to 60 characters',
