      ...
      <el-col :xs="12" :sm="24" :lg="15">
        <el-card class="box-card" style="margin-bottom:40px">
          <div slot="header" class="clearfix">
            ...
            <span style="font-size:17px;line-height:40px">Global map</span>
            <div style="float:right">
              <el-select
                v-model="mapColor"
                class="input-width"
                placeholder="Selection of color"
                style="width:120px;"
                size="medium"
                @change="changeColor()"
              >
                <el-option label="Color theme1" :value="1"></el-option>
                <el-option label="Color theme2" :value="2"></el-option>
                <el-option label="Color theme3" :value="3"></el-option>
                <el-option label="Color theme4" :value="4"></el-option>
                <el-option label="Color theme5" :value="5"></el-option>
              </el-select>
            </div>
          </div>
      ...
      <el-col :xs="12" :sm="24" :lg="9">
        <el-card class="box-card" style="margin-bottom:30px">
          <div slot="header" class="clearfix">
            ...
            <span>Convenient navigation</span>
          </div>
          <div>
...
export default {
  ...
  methods: {
    changeColor() {
      ...
      this.msgSuccess('Replace the color theme success')
    },
    ...
    handlePushRoute(url) {
      if (url == '') this.msgError('This feature is not open yet')
