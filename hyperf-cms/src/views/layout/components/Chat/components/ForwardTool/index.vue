<template>
  <el-dialog title="My contact person" :visible.sync="forwardTool.dialogVisible" width="38%" append-to-body>
    <div class="filter-container">
      ...
      <div class="selected-fields">
        <div class="box-head">
          <el-divider content-position="left">Selected user list （{{checkedContacts.length}}）</el-divider>
        </div>
    ...
    <div slot="footer" class="dialog-footer">
      <el-button @click="forwardTool.dialogVisible = false" size="medium">Cancel</el-button>
      <el-button type="primary" @click="handleForwardMessage()" size="medium">OK</el-button>
    </div>
  </el-dialog>
</template>
<script>
