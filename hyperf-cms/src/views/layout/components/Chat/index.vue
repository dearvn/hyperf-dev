  ...
  <div class="chatMain">
    ...
    >
      <lemon-imui
        ...
        width="1050px"
        height="700px"
        loadendText="Only show the last 30 pieces of information"
      ...
      >
            ...
            <div style="line-height:32px">
              ...
              >
                <span @click="handleOpenGroupTool('group_file', contact)">
                  <el-tooltip class="item" effect="dark" content="Group file" placement="top">
                ...
                <span @click="handleOpenGroupTool('group_notice', contact)">
                  <el-tooltip class="item" effect="dark" content="Group announcement" placement="top">
                ...
                <span @click="handleOpenGroupTool('group_album', contact)">
                  <el-tooltip class="item" effect="dark" content="Group album" placement="top">
                ...
                >
                  <el-tooltip class="item" effect="dark" content="Group invitation" placement="top">
                ...
                <span @click="handleOpenGroupTool('group_setting', contact)">
                  <el-tooltip class="item" effect="dark" content="Group settings" placement="top">
                    <el-dropdown trigger="click" placement="bottom" @command="handleCommand">
                      ...
                      <el-dropdown-menu slot="dropdown">
                        ...
                        >Group member management</el-dropdown-item>
                        <el-dropdown-item
                          v-if="contact.level != 2"
                          icon="el-icon-edit"
                          :command="composeValue('group_edit', contact)"
                        >Modify group configuration</el-dropdown-item>
                        <el-dropdown-item
                          v-if="contact.level != 0"
                          icon="el-icon-circle-close"
                          :command="composeValue('group_exit', contact)"
                        >Exit the group</el-dropdown-item>
                        <el-dropdown-item
                          v-if="contact.level == 0"
                          icon="el-icon-delete"
                          :command="composeValue('group_delete', contact)"
                        >Disopoly</el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
                  </el-tooltip>
                </span>
                <span style="margin-right:10px" @click="changeDrawer(contact, $refs.IMUI)">
                  <el-tooltip class="item" effect="dark" content="Group drawer" placement="top">
        ...
        <template #editor-footer>
          <div>
            <span>use {{ settingDialogData.sendText }} Quickly send messages</span>
          </div>
        </template>
          ...
          <div style="margin-bottom:10px">
            <p style="margin-top:10px;margin-left:10px;">
              <el-autocomplete
                ...
                placeholder="Please enter the search contact"
              ...
              <el-dropdown trigger="click" size="small" style="margin-left:10px">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item divided>
                    <span @click="handleCreateGroup(instance)" style="display: block">Create group chat</span>
                  </el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </p>
...
export default {
      ...
      contextmenu: [
        {
          click: (e, instance, hide) => {
            ...
            if (getTime() - message.sendTime > 120000) {
              this.$message({
                message: 'The delivery time exceeds two minutes, and the withdrawal is not allowed',
                type: 'error',
              })
            } else {
              const data = {
                id: generateRandId(),
                type: 'event',
                //When using JSX, the click must use the arrow function (so that the context stays in Vue)
                content: (
                  <div>
                    <span>
          ...
          text: "<i class='el-icon-s-flag' style='margin-right:10px'></i><span>Withdraw the message</span>",
        },
        {
          visible: (instance) => {
            return instance.message.type == 'image'
          },
          text: "<i class='el-icon-picture-outline' style='margin-right:10px'></i><span>Download pictures</span>",
          click: (e, instance, hide) => {
            const { IMUI, message } = instance
        ...
        },
        {
          ...
          text: "<i class='el-icon-download' style='margin-right:10px'></i><span>Download file</span>",
        },
        {
          click: (e, instance, hide) => {
            const { IMUI, message } = instance
          ...
          color: '#606266',
          text: "<i class='el-icon-delete' style='margin-right:10px'></i><span>Delete</span>",
        },
        {
          click: (e, instance, hide) => {
            const { IMUI, message } = instance
          ...
          color: '#606266',
          text: "<i class='el-icon-s-promotion' style='margin-right:10px'></i><span>Forward</span>",
        },
        {
          click: (e, instance, hide) => {
            const { IMUI, message } = instance
          ...
          color: '#606266',
          text: "<i class='el-icon-connection' style='margin-right:10px'></i><span>Quote</span>",
        },
        {
          click: (e, instance, hide) => {
            const { IMUI, message } = instance
          ...
          color: '#606266',
          text: "<i class='el-icon-finished' style='margin-right:10px'></i><span>Choice</span>",
        },
      ],
      contactContextmenu: [
        {
          text: "<i class='el-icon-chat-line-round' style='margin-right:10px'></i><span>Friends information</span>",
          click: (e, instance, hide) => {
        ...
        {
          text: "<i class='el-icon-edit' style='margin-right:10px'></i><span>Modify</span>",
          click: (e, instance, hide) => {
            const { IMUI, contact } = instance
            IMUI.updateContact({
              id: contact.id,
        ...
        {
          text: "<i class='el-icon-upload2' style='margin-right:10px'></i><span>Peak</span>",
          click: (e, instance, hide) => {
            const { IMUI, contact } = instance
            IMUI.updateContact({
              id: contact.id,
        ...
        {
          text: "<i class='el-icon-close-notification' style='margin-right:10px'></i><span>Message exemption</span>",
          click: (e, instance, hide) => {
            const { IMUI, contact } = instance
            IMUI.updateContact({
              id: contact.id,
        ...
        {
          text: " <el-divider></el-divider><i class='el-icon-circle-close' style='color:#F56C6C' ><span style='padding-left:10px;'>Exit group chat</span></i>",
          click: (e, instance, hide) => {
            const { IMUI, contact } = instance
            IMUI.updateContact({
              id: contact.id,
  ...
  created() {
    ...
    document.onkeydown = function (e) {
      ...
      //In the event, keycode=13 is a carriage return event
      if (
