<template>
  <div>
    <el-tooltip class="item" effect="dark" content="layout" placement="top-start">
    ...
    <el-drawer :visible.sync="drawer" direction="rtl" size="15%" :with-header="false" ref="drawer">
      <div class="drawer-container">
        <div>
          ...
          <div class="drawer-item">
            <span>Open TopNav</span>
            <el-switch v-model="topNav" class="drawer-switch" />
          </div>

          <div class="drawer-item">
            <span>Open Tags-Views</span>
          ...
          <div class="drawer-item">
            <span>Enter the background prompt</span>
  ...
  methods: {
    ...
    saveSetting() {
      const loading = this.$loading({
        lock: true,
        fullscreen: true,
        text: 'It is being stored in the local area, please later ...',
    ...
    resetSetting() {
      this.$loading({
        lock: true,
        fullscreen: false,
        text: 'Clear the settings and refresh, please later ...',
        spinner: 'el-icon-loading',
        background: 'rgba(0, 0, 0, 0.7)',
      })
