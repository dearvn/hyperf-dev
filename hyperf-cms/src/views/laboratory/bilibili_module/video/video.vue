  ...
  <div class="app-container">
    ...
    >
      <template slot="extraForm">
        ...
        <el-form-item label="Publish time selection：">
          <el-date-picker
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 1, field: 'cover', label: `Video cover map`, visible: true },
        { key: 2, field: 'title', label: `Title`, visible: true },
        { key: 3, field: 'desc', label: `Video description`, visible: true },
        { key: 4, field: 'ownen', label: `Author`, visible: true },
        { key: 5, field: 'public_time', label: `Release time`, visible: true },
        { key: 6, field: 'duration', label: `Playback time`, visible: true },
        { key: 7, field: 'timed_status', label: `Timing task status`, visible: true },
      ],
    }
  },
  created() {
