  ...
  <div class="app-container">
      ...
      <template slot="extraForm">
        <el-form-item label="Video ID search：">
          <el-select
            ...
            remote
            reserve-keyword
            placeholder="Please fill in the ID of the search video"
    ...
    <div class="table-container">
      <el-table ref="videoDataReport" :data="list" style="width: 100%;" size="mini" border>
        ...
        <el-table-column label="Video playback" sortable prop="view" v-if="columns[1].visible">
        ...
        <el-table-column label="Number of barrage" sortable prop="danmaku" v-if="columns[2].visible">
          <template slot-scope="scope">
            {{scope.row.danmaku}}
            <span v-if="listQuery.is_trend == 1">
              （
        ...
        <el-table-column label="Number of comments" sortable prop="reply" v-if="columns[3].visible">
          <template slot-scope="scope">
            {{scope.row.reply}}
            <span v-if="listQuery.is_trend == 1">
              （
        ...
        <el-table-column label="Collecting number" sortable prop="favorite" v-if="columns[4].visible">
          <template slot-scope="scope">
            {{scope.row.favorite}}
            <span v-if="listQuery.is_trend == 1">
              （
        ...
        <el-table-column label="Coin number" sortable prop="coin" v-if="columns[5].visible">
          <template slot-scope="scope">
            {{scope.row.coin}}
            <span v-if="listQuery.is_trend == 1">
              （
        ...
        <el-table-column label="Number of likes" sortable prop="likes" v-if="columns[6].visible">
          <template slot-scope="scope">
            {{scope.row.likes}}
            <span v-if="listQuery.is_trend == 1">
              （
        ...
        <el-table-column label="Stepping on" sortable prop="dislike" v-if="columns[7].visible">
          <template slot-scope="scope">
            {{scope.row.dislike}}
            <span v-if="listQuery.is_trend == 1">
              （
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 1, field: 'view', label: `Video playback`, visible: true },
        { key: 2, field: 'danmaku', label: `Number of barrage`, visible: true },
        { key: 3, field: 'reply', label: `Number of comments`, visible: true },
        { key: 4, field: 'favorite', label: `Collect number`, visible: true },
        { key: 5, field: 'coin', label: `Coin number`, visible: true },
        { key: 6, field: 'likes', label: `Number of likes`, visible: true },
        { key: 7, field: 'dislike', label: `Stepping on`, visible: true },
      ],
    }
  },
  created() {
