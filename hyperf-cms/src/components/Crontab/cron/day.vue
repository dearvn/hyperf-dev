<template lang="html">
  <div :val="value_">
    <div>
      <el-radio v-model="type" label="1" size="mini" border>Daily</el-radio>
    </div>
    <div>
    ...
    <div>
      ...
      <span style="margin-left: 5px; margin-right: 5px;">Start at the beginning of the day, every day</span>
    ...
    <div>
      <el-radio v-model="type" label="8" size="mini" border>Working day</el-radio>
      ...
      No., the recent working day
    </div>
    <div>
      <el-radio v-model="type" label="6" size="mini" border>The last day of this month</el-radio>
    </div>
    <div>
